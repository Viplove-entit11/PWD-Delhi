...
const Services = () => {
  const quickAccessServices = [
    ...
    {
      icon: <ExclamationCircleOutlined style={{ fontSize: '32px', color: '#ff4d4f' }} />,
    ...
    {
      icon: <ClockCircleOutlined style={{ fontSize: '32px', color: '#fadb14' }} />,
      title: 'Awareness',
  ...
  const coreServices = [
    {
      ...
      description: 'Comprehensive street lighting solutions and maintenance services',
      badge: null,
      badgeColor: '#fa8c16',
      bgColor: '#0846aa'
    },
    ...
    {
      icon: <ExclamationCircleOutlined style={{ fontSize: '24px', color: '#666' }} />,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Paragraph style={{
            ...
            Access comprehensive public works services designed to serve Delhi's citizens 
            efficiently.
          </Paragraph>
        </div>
      </div>
                ...
                >
                  ...
                  <div style={{
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <Text style={{ 
                        color: service.bgColor === '#f5f5f5' ? '#666' : 'rgba(255,255,255,0.9)',
                        fontSize: '13px',
                        lineHeight: '1.4',
                        display: 'block',
                        marginBottom: '16px'
                  ...
                  <Button 
                    ...
                    style={{ 
                      backgroundColor: service.bgColor === '#f5f5f5' ? '#fff' : 'rgba(255,255,255,0.2)',
                      borderColor: service.bgColor === '#f5f5f5' ? '#d9d9d9' : 'rgba(255,255,255,0.3)',
                      color: service.bgColor === '#f5f5f5' ? '#333' : '#fff',
                      fontSize: '13px',
                      fontWeight: '500',
                      borderRadius: '6px'
